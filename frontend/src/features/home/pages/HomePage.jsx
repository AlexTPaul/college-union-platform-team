...
export default function HomePage({ role }) { const {go,notify}=useOutletContext();
 return <>
  <Reveal className="hero-reveal"><div className="hero">
   <div><span className="eyebrow light">SATURDAY • AUGUST 29, 2026</span><h1>Good morning, Aswin.</h1><p>Your campus, union services and opportunities — all in one place.</p>
